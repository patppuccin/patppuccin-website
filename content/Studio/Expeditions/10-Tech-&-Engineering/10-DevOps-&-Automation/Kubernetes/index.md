...
![BMs-VMs-Containers.png](../../../../../Appendix/BMs-VMs-Containers.png)
...
- Some of the most commonly used container orchestration platforms are
	...
	2. [Docker Swarm](/Docker%20Swarm) - A native clustering and orchestration solution for [Docker](../../../../../../Docker.md).
...
> 
> ![meme-containerd-and-kubernetes.png](../../../../../Appendix/meme-containerd-and-kubernetes.png)
> 
...
2. **Container Runtime**
	...
	- Any container runtimes that follow the OCI spec can be used as the container runtime. Some of the most popular choices include *[containerd](/containerd)* and *[Docker](../../../../../../Docker.md)*. 
3. **Kube proxy**
