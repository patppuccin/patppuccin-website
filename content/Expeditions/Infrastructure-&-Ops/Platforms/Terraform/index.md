...
2. **Terraform CLI (Command-Line Interface)**
    ...
    - The terraform CLI is written in [Golang](../../../Programming/Languages/Golang/index.md).
...
4. **Terraform Core**
    ...
    - It is also written in [Golang](../../../Programming/Languages/Golang/index.md) and comes bundled with the CLI. 
